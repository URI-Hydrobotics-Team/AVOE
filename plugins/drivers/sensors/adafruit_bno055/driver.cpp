...
void delay(unsigned int ms){
	...
	gpioSleep(PI_TIME_RELATIVE, 0, 1000*ms);
...
bool Adafruit_BNO055::begin(adafruit_bno055_opmode_t mode) {
	...
	// delay for 850ms
	gpioSleep(PI_TIME_RELATIVE, 0, 1000*850);
...
/*!
 *  @brief  Provides the adafruit_sensor_t data for this sensor
 *  @param  sensor
 *          Sensor description
 */
void Adafruit_BNO055::getSensor(adafruit_sensor_t *sensor) {
